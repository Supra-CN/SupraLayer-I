...
import cn.supra.supralayer.ui.dialogs.GeolocationPermissionsDialog;
...
//                    
//                    switch(actionId) {
//                    case SpaceActivity.CONTEXT_MENU_OPEN:
...
//                    case SpaceActivity.CONTEXT_MENU_OPEN_IN_NEW_TAB:
//                        
//                        if (HitTestResult.SRC_IMAGE_ANCHOR_TYPE == intent.getIntExtra(Constants.EXTRA_HIT_TEST_RESULT, -1)) {
...
//                    case SpaceActivity.CONTEXT_MENU_OPEN_IN_BACKGROUND:
//                        
//                        if (HitTestResult.SRC_IMAGE_ANCHOR_TYPE == intent.getIntExtra(Constants.EXTRA_HIT_TEST_RESULT, -1)) {
...
//                    case SpaceActivity.CONTEXT_MENU_DOWNLOAD:
//                        if (HitTestResult.SRC_IMAGE_ANCHOR_TYPE == intent.getIntExtra(Constants.EXTRA_HIT_TEST_RESULT, -1)) {
...
//                    case SpaceActivity.CONTEXT_MENU_SHARE:
//                        if (HitTestResult.SRC_IMAGE_ANCHOR_TYPE == intent.getIntExtra(Constants.EXTRA_HIT_TEST_RESULT, -1)) {
...
//                    case SpaceActivity.CONTEXT_MENU_COPY:
